...
def flappygame():
    ...
    while True:
        ...
        if 15 < your_score < 18:
            collision = False
            # show power up text
            gameOverScreen_TEXT = get_font(55).render("Invincible", True,
                                                      "Yellow")
            gameOverScreen_RECT = gameOverScreen_TEXT.get_rect(
                center=(300, 50))
        ...
        if (your_score % 5 == 0 and your_score != 0):
            ...
            positionScore -= .02
            # UpperBound -= .02
            gameOverScreen_TEXT = get_font(55).render("SLOW DOWN",
                                                      True, "Blue")
            gameOverScreen_RECT = gameOverScreen_TEXT.get_rect(
                center=(300, 50))
            window.blit(gameOverScreen_TEXT, gameOverScreen_RECT)
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(55).render("Shiba Inu", True, "Red")
        ...
        # Change button color when hover over
